...
# States: AL AR FL GA KS LA MS NC TN TX VA 
```{r, warning=FALSE, message=FALSE}
south_cand <- candidatesFunc( party1 = "DEM", party2 = "REP", s1 = "AL", s2 = "AR", s3 = "FL", s4 = "GA", s5 = "KS", s6 = "LA", s7  = "MS", s8 = "NC", s9 = "TN", s10 = "TX", s11 = "VA" )
```
...
ggplot( south_cand, aes(x = cand_office_state, y = n, fill = cand_party_affiliation, width = .5)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  theme_minimal() +
  ggtitle("Candidate Party Affiliation in Southern States") +
  scale_fill_manual(values = alpha(c("steelblue2", "indianred2"))) +
  labs( fill = "Candidate Party Affiliation") +
  labs(x = "Candidate's Office State") +
  labs(y = " # of Candidates in Each Party")
...
```{r, warning=FALSE, message=FALSE}
mount_cand <- candidatesFunc( party1 = "DEM", party2 = "REP", s1 = "AZ", s2 = "CA", s3 = "CO", s4 = "ID", s5 = "MO", s6 = "NM", s7  = "NV", s8 = "OR", s9 = "UT", s10 = "WA", s11 = "WY" )
```
...
ggplot( mount_cand, aes(x = cand_office_state, y = n, fill = cand_party_affiliation, width = .5)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  theme_minimal() +
  ggtitle("Candidate Party Affiliation in Western States") +
  scale_fill_manual(values = alpha(c("steelblue2", "indianred2"))) +
  labs( fill = "Candidate Party Affiliation") +
  labs(x = "Candidate's Office State") +
  labs(y = " # of Candidates in Each Party")
...
# Candidates in MidWestern States
# ABC ORDER: AZ, CA, CO, ID, MO, NM, NV, OR, UT, WA, WY, 
```{r, warning=FALSE, message=FALSE}
midwest_cand <- candidatesFunc( party1 = "DEM", party2 = "REP", s1 = "AZ", s2 = "CA", s3 = "CO", s4 = "ID", s5 = "MO", s6 = "NM", s7  = "NV", s8 = "OR", s9 = "UT", s10 = "WA", s11 = "WY" )
```

```{r}
ggplot( midwest_cand, aes(x = cand_office_state, y = n, fill = cand_party_affiliation, width = .5)) +
  geom_bar(stat = "identity", position = position_dodge()) +
  theme_minimal() +
  ggtitle("Candidate Party Affiliation in Mid-Western States") +
  scale_fill_manual(values = alpha(c("steelblue2", "indianred2"))) +
  labs( fill = "Candidate Party Affiliation") +
  labs(x = "Candidate's Office State") +
  labs(y = " # of Candidates in Each Party")
...
# Committees Party Affiliation in Southern States
# States: AL AR FL GA KS LA MS NC TN TX VA 
```{r, warning=FALSE, message=FALSE}
south_com <- committeesFunc( party1 = "DEM", party2 = "REP", s1 = "AL", s2 = "AR", s3 = "FL", s4 = "GA", s5 = "KS", s6 = "LA", s7  = "MS", s8 = "NC", s9 = "TN", s10 = "TX", s11 = "VA" )
```

```{r}
ggplot( south_com, aes(x = cmte_state, y = n, fill = cmte_party_affiliation, width = .5) ) +
  geom_bar(stat = "identity", position = position_dodge()) +
  theme_minimal() +
  ggtitle("Committee Party Affiliation in Southern States") +
  scale_fill_manual(values = alpha(c("steelblue2", "indianred2"))) +
  labs( fill = "Committee Party Affiliation") +
  labs(x = "Committee's State") +
  labs(y = "# of Committees in Each Party")
...
# States: AZ, CA, CO, ID, MO, NM, NV, OR, UT, WA, WY
```{r, warning=FALSE, message=FALSE}
west_com <- committeesFunc( party1 = "DEM", party2 = "REP", s1 = "AZ", s2 = "CA", s3 = "CO", s4 = "ID", s5 = "MO", s6 = "NM", s7  = "NV", s8 = "OR", s9 = "UT", s10 = "WA", s11 = "WY" )
```

```{r}
ggplot( west_com, aes(x = cmte_state, y = n, fill = cmte_party_affiliation, width = .5) ) +
  geom_bar(stat = "identity", position = position_dodge()) +
  theme_minimal() +
  ggtitle("Committee Party Affiliation in Western States") +
  scale_fill_manual(values = alpha(c("steelblue2", "indianred2"))) +
  labs( fill = "Committee Party Affiliation") +
  labs(x = "Committee's State") +
  labs(y = "# of Committees in Each Party")
